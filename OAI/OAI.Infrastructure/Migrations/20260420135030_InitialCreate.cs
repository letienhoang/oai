        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaredSubtotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeclaredSubtotalCurrency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    DeclaredTaxAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeclaredTaxCurrency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    DeclaredTotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeclaredTotalCurrency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "InvoiceExtractionResults",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EngineName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceExtractionResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceExtractionResults_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceExtractionResults_InvoiceId",
                table: "InvoiceExtractionResults",
                column: "InvoiceId");
