...
public sealed class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
{
    public void Configure(EntityTypeBuilder<Invoice> builder)
    {
        ...
        {
            money.Property(x => x.Amount).HasColumnName("DeclaredSubtotalAmount");
        ...
        {
            money.Property(x => x.Amount).HasColumnName("DeclaredTaxAmount");
        ...
        {
            money.Property(x => x.Amount).HasColumnName("DeclaredTotalAmount");
